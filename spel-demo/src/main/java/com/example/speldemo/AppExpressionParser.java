...
public class AppExpressionParser {
    public static void main (String[] args) {
        ...
        parser.parseExpression("timeZone").setValue(userContext, "America/New York");
        ...
        System.out.println("user.country:" + System.getProperties().getProperty("user.country"));
        Expression expCountry = parser.parseExpression("#systemProperties['user.country']");
        System.out.println("getValue" + expCountry.getValue(propsContext));
